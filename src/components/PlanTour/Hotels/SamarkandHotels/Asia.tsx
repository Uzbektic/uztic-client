...
const AsiaHotel = () => {
  ...
  const previousChargesRef = useRef({
    samarkandHotel__asiaSamarkand__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'samarkandHotel__asiaSamarkand__standard',
      ...
      updateRoomCharge(
        'samarkandHotel__asiaSamarkand__standard',
        SAMARKAND_HOTEL_RATES.asiaSamarkand.standard
      );
    ...
    formData.samarkandHotel__asiaSamarkand__standard,
    formData.samarkandHotel__asiaSamarkand__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Asia Samarkand</Typography>
          <FormGroup>
            <Controller
              name="samarkandHotel__asiaSamarkand__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.samarkandHotel__asiaSamarkand__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="samarkandHotel__asiaSamarkand__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
