                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              SAMARKAND_HOTEL_RATES.movenPick.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              SAMARKAND_HOTEL_RATES.movenPick.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
                      ...
                      <div style={{ paddingLeft: 20 }}>
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.SINGLE} - $${
                              SAMARKAND_HOTEL_RATES.movenPick.executive.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              SAMARKAND_HOTEL_RATES.movenPick.executive.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
