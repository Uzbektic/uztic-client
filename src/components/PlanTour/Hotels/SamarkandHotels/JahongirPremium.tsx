...
const JahongirPremiumHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    samarkandHotel__jahongirPremium__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'samarkandHotel__jahongirPremium__standard',
      ...
      updateRoomCharge(
        'samarkandHotel__jahongirPremium__standard',
        SAMARKAND_HOTEL_RATES.jahongirPremium.standard
      );
    ...
    formData.samarkandHotel__jahongirPremium__standard,
    formData.samarkandHotel__jahongirPremium__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Jahongir Premium</Typography>
          <FormGroup>
            <Controller
              name="samarkandHotel__jahongirPremium__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.samarkandHotel__jahongirPremium__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="samarkandHotel__jahongirPremium__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
...
export default JahongirPremiumHotel;
