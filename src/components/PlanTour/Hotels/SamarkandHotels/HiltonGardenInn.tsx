...
const HiltonGardenInnHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    samarkandHotel__hiltonGardenInn__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'samarkandHotel__hiltonGardenInn__standard',
      ...
      updateRoomCharge(
        'samarkandHotel__hiltonGardenInn__standard',
        SAMARKAND_HOTEL_RATES.hiltonGardenInn.standard
      );
    ...
    formData.samarkandHotel__hiltonGardenInn__standard,
    formData.samarkandHotel__hiltonGardenInn__standard__room,
      ...
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">
            Hilton Garden Inn Afrosiyob (Rowing canal)
          </Typography>
          <FormGroup>
            <Controller
              name="samarkandHotel__hiltonGardenInn__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.samarkandHotel__hiltonGardenInn__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="samarkandHotel__hiltonGardenInn__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
...
export default HiltonGardenInnHotel;
