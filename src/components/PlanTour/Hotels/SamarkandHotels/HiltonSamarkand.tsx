...
const HiltonSamarkandHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    samarkandHotel__hiltonSamarkandRegency__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'samarkandHotel__hiltonSamarkandRegency__standard',
      ...
      updateRoomCharge(
        'samarkandHotel__hiltonSamarkandRegency__standard',
        SAMARKAND_HOTEL_RATES.hiltonSamarkandRegency.standard
      );
    ...
    formData.samarkandHotel__hiltonSamarkandRegency__standard,
    formData.samarkandHotel__hiltonSamarkandRegency__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Hilton Samarkand Regency</Typography>
          <FormGroup>
            <Controller
              name="samarkandHotel__hiltonSamarkandRegency__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.samarkandHotel__hiltonSamarkandRegency__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="samarkandHotel__hiltonSamarkandRegency__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              SAMARKAND_HOTEL_RATES.hiltonSamarkandRegency
                                .standard.single + priceIncrease
                            }`}
                          />
                          <FormControlLabel
...
export default HiltonSamarkandHotel;
