...
const HiltonGardenHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    samarkandHotel__hiltonGarden__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'samarkandHotel__hiltonGarden__standard',
      ...
      updateRoomCharge(
        'samarkandHotel__hiltonGarden__standard',
        SAMARKAND_HOTEL_RATES.hiltonGarden.standard
      );
    ...
    formData.samarkandHotel__hiltonGarden__standard,
    formData.samarkandHotel__hiltonGarden__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Hilton Garden Inn Samarkand</Typography>
          <FormGroup>
            <Controller
              name="samarkandHotel__hiltonGarden__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.samarkandHotel__hiltonGarden__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="samarkandHotel__hiltonGarden__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
...
export default HiltonGardenHotel;
