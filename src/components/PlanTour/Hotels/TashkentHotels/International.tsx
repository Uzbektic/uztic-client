...
const InternationalHotel = () => {
  ...
  const previousChargesRef = useRef({
    tashkentHotel__international__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'tashkentHotel__international__standard',
      ...
      updateRoomCharge(
        'tashkentHotel__international__standard',
        TASHKENT_HOTEL_RATES.international.standard
      );
    ...
    formData.tashkentHotel__international__standard,
    formData.tashkentHotel__international__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">International Hotel Tashkent</Typography>
          <FormGroup>
            <Controller
              name="tashkentHotel__international__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.tashkentHotel__international__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="tashkentHotel__international__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
