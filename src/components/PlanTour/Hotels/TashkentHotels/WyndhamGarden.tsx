...
const WyndhamGardenHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    tashkentHotel__wyndhamGarden__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'tashkentHotel__wyndhamGarden__standard',
      ...
      updateRoomCharge(
        'tashkentHotel__wyndhamGarden__standard',
        TASHKENT_HOTEL_RATES.wyndhamGarden.standard
      );
    ...
    formData.tashkentHotel__wyndhamGarden__standard,
    formData.tashkentHotel__wyndhamGarden__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Wyndham Garden Tashkent</Typography>
          <FormGroup>
            <Controller
              name="tashkentHotel__wyndhamGarden__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.tashkentHotel__wyndhamGarden__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="tashkentHotel__wyndhamGarden__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
...
export default WyndhamGardenHotel;
