...
const AlAnvarHalolHotel = () => {
  const [priceIncrease, setPriceIncrease] = useState(
    INCREASE_RATES_FOR_TOURISTS
  );

  const previousChargesRef = useRef({
    tashkentHotel__alAnvarHalol__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'tashkentHotel__alAnvarHalol__standard',
      ...
      updateRoomCharge(
        'tashkentHotel__alAnvarHalol__standard',
        TASHKENT_HOTEL_RATES.alAnvarHalol.standard
      );
    ...
    formData.tashkentHotel__alAnvarHalol__standard,
    formData.tashkentHotel__alAnvarHalol__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Al Anvar Halol Hotel</Typography>
          <FormGroup>
            <Controller
              name="tashkentHotel__alAnvarHalol__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.tashkentHotel__alAnvarHalol__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="tashkentHotel__alAnvarHalol__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
...
export default AlAnvarHalolHotel;
