...
const RayyanHotel = () => {
  ...
  const previousChargesRef = useRef({
    tashkentHotel__rayyan__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'tashkentHotel__rayyan__standard',
      ...
      updateRoomCharge(
        'tashkentHotel__rayyan__standard',
        TASHKENT_HOTEL_RATES.rayyan.standard
      );
    ...
    formData.tashkentHotel__rayyan__standard,
    formData.tashkentHotel__rayyan__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Rayyan Hotel Tashkent</Typography>
          <FormGroup>
            <Controller
              name="tashkentHotel__rayyan__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.tashkentHotel__rayyan__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="tashkentHotel__rayyan__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              TASHKENT_HOTEL_RATES.rayyan.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              TASHKENT_HOTEL_RATES.rayyan.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
