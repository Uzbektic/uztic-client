...
const ShamsanHotel = () => {
  ...
  const previousChargesRef = useRef({
    tashkentHotel__shamsan__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'tashkentHotel__shamsan__standard',
      ...
      updateRoomCharge(
        'tashkentHotel__shamsan__standard',
        TASHKENT_HOTEL_RATES.shamsan.standard
      );
    ...
    formData.tashkentHotel__shamsan__standard,
    formData.tashkentHotel__shamsan__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Shamsan Hotel</Typography>
          <FormGroup>
            <Controller
              name="tashkentHotel__shamsan__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.tashkentHotel__shamsan__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="tashkentHotel__shamsan__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              TASHKENT_HOTEL_RATES.shamsan.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              TASHKENT_HOTEL_RATES.shamsan.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
