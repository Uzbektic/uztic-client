...
const ParadiseHotel = () => {
  const previousChargesRef = useRef({
    ...
    bukharaHotel__paradise__deluxe: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey:
          | 'bukharaHotel__paradise__standard'
          | 'bukharaHotel__paradise__deluxe'
          | 'bukharaHotel__paradise__triple',
      ...
      updateRoomCharge(
        'bukharaHotel__paradise__standard',
        BUKHARA_HOTEL_RATES.paradise.standard
      );

      updateRoomCharge(
        'bukharaHotel__paradise__triple',
        BUKHARA_HOTEL_RATES.paradise.triple
      );

      updateRoomCharge(
        'bukharaHotel__paradise__deluxe',
        BUKHARA_HOTEL_RATES.paradise.deluxe
      );
    ...
    formData.bukharaHotel__paradise__standard,
    formData.bukharaHotel__paradise__standard__room,
    formData.bukharaHotel__paradise__deluxe,
    formData.bukharaHotel__paradise__deluxe__room,
    formData.bukharaHotel__paradise__triple,
    formData.bukharaHotel__paradise__triple__room,
    setValue,
  ]);
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Paradise Plaza</Typography>
          <FormGroup>
            <Controller
              name="bukharaHotel__paradise__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.bukharaHotel__paradise__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="bukharaHotel__paradise__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
            ...
            <Controller
              name="bukharaHotel__paradise__deluxe"
              control={control}
              defaultValue={false}
              render={({ field: { onChange, value } }) => (
                <FormControlLabel
            ...
            {formData.bukharaHotel__paradise__deluxe && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  <Typography variant="h4">Room Size</Typography>
                  <Controller
                    name="bukharaHotel__paradise__deluxe__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                      <div style={{ paddingLeft: 20 }}>
            ...
            <Controller
              name="bukharaHotel__paradise__triple"
              control={control}
              defaultValue={false}
              render={({ field: { onChange, value } }) => (
                <FormControlLabel
            ...
            {formData.bukharaHotel__paradise__triple && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  <Typography variant="h4">Room Size</Typography>
                  <Controller
                    name="bukharaHotel__paradise__triple__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                      <div style={{ paddingLeft: 20 }}>
