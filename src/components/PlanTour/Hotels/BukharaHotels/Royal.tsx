...
const RoyalHotel = () => {
  const previousChargesRef = useRef({
    bukharaHotel__royal__standard: 0,
    bukharaHotel__royal__triple: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey:
          | 'bukharaHotel__royal__standard'
          | 'bukharaHotel__royal__triple',
      ...
      updateRoomCharge(
        'bukharaHotel__royal__standard',
        BUKHARA_HOTEL_RATES.royal.standard
      );

      updateRoomCharge(
        'bukharaHotel__royal__triple',
        BUKHARA_HOTEL_RATES.royal.triple
      );
    ...
    formData.bukharaHotel__royal__standard,
    formData.bukharaHotel__royal__standard__room,
    formData.bukharaHotel__royal__triple,
    formData.bukharaHotel__royal__triple__room,
    setValue,
  ]);
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Royal Bukhara</Typography>
          <FormGroup>
            <Controller
              name="bukharaHotel__royal__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.bukharaHotel__royal__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="bukharaHotel__royal__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                      <div style={{ paddingLeft: 20 }}>
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.SINGLE} - $${BUKHARA_HOTEL_RATES.royal.standard.single}`}
                          />
                          <FormControlLabel
                            value={ROOM_SIZES.DOUBLE}
                            control={<Radio />}
                            label={`${ROOM_SIZES.DOUBLE} - $${BUKHARA_HOTEL_RATES.royal.standard.double}`}
                          />
                        </RadioGroup>
                      </div>
                    )}
            ...
            <Controller
              name="bukharaHotel__royal__triple"
              control={control}
              defaultValue={false}
              render={({ field: { onChange, value } }) => (
                <FormControlLabel
            ...
            {formData.bukharaHotel__royal__triple && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  <Typography variant="h4">Room Size</Typography>
                  <Controller
                    name="bukharaHotel__royal__triple__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                      <div style={{ paddingLeft: 20 }}>
                        <RadioGroup {...field}>
                          <FormControlLabel
                            value={ROOM_SIZES.SINGLE}
                            control={<Radio />}
                            label={`${ROOM_SIZES.SINGLE} - $${BUKHARA_HOTEL_RATES.royal.triple.single}`}
                          />
                        </RadioGroup>
                      </div>
                    )}
