...
const HiltonHotel = () => {
  ...
  const previousChargesRef = useRef({
    bukharaHotel__hiltonSamarakand__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'bukharaHotel__hiltonSamarakand__standard',
      ...
      updateRoomCharge(
        'bukharaHotel__hiltonSamarakand__standard',
        BUKHARA_HOTEL_RATES.hiltonSamarakand.standard
      );
    ...
    formData.bukharaHotel__hiltonSamarakand__standard,
    formData.bukharaHotel__hiltonSamarakand__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          ...
          <FormGroup>
            <Controller
              name="bukharaHotel__hiltonSamarakand__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.bukharaHotel__hiltonSamarakand__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="bukharaHotel__hiltonSamarakand__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
