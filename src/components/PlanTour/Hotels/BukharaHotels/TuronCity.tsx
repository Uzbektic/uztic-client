                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              BUKHARA_HOTEL_RATES.turonCity.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              BUKHARA_HOTEL_RATES.turonCity.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
                      ...
                      <div style={{ paddingLeft: 20 }}>
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.SINGLE} - $${
                              BUKHARA_HOTEL_RATES.turonCity.deluxe.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              BUKHARA_HOTEL_RATES.turonCity.deluxe.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
