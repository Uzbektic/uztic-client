...
const RayyanHotel = () => {
  ...
  const previousChargesRef = useRef({
    bukharaHotel__rayyan__standard: 0,
    bukharaHotel__rayyan__triple: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey:
          | 'bukharaHotel__rayyan__standard'
          | 'bukharaHotel__rayyan__triple',
      ...
      updateRoomCharge(
        'bukharaHotel__rayyan__standard',
        BUKHARA_HOTEL_RATES.rayyan.standard
      );

      updateRoomCharge(
        'bukharaHotel__rayyan__triple',
        BUKHARA_HOTEL_RATES.rayyan.triple
      );
    ...
    formData.bukharaHotel__rayyan__standard,
    formData.bukharaHotel__rayyan__standard__room,
    formData.bukharaHotel__rayyan__triple,
    formData.bukharaHotel__rayyan__triple__room,
    setValue,
  ]);
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Rayyan Hotel Bukhara</Typography>
          <FormGroup>
            <Controller
              name="bukharaHotel__rayyan__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.bukharaHotel__rayyan__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="bukharaHotel__rayyan__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              BUKHARA_HOTEL_RATES.rayyan.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              BUKHARA_HOTEL_RATES.rayyan.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
            ...
            <Controller
              name="bukharaHotel__rayyan__triple"
              control={control}
              defaultValue={false}
              render={({ field: { onChange, value } }) => (
                <FormControlLabel
            ...
            {formData.bukharaHotel__rayyan__triple && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  <Typography variant="h4">Room Size</Typography>
                  <Controller
                    name="bukharaHotel__rayyan__triple__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                      <div style={{ paddingLeft: 20 }}>
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            control={<Radio />}
                            label={`${ROOM_SIZES.SINGLE} - $${
                              BUKHARA_HOTEL_RATES.rayyan.triple.single +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
