...
const AsiaHotel = () => {
  ...
  const previousChargesRef = useRef({
    bukharaHotel__asiaBukhara__standard: 0,
  });
  ...
  useEffect(() => {
    const calculateAndUpdateTotal = () => {
      ...
      const updateRoomCharge = (
        hotelKey: 'bukharaHotel__asiaBukhara__standard',
      ...
      updateRoomCharge(
        'bukharaHotel__asiaBukhara__standard',
        BUKHARA_HOTEL_RATES.asiaBukhara.standard
      );
    ...
    formData.bukharaHotel__asiaBukhara__standard,
    formData.bukharaHotel__asiaBukhara__standard__room,
    ...
    <>
      <Grid xs={12} item>
        <div style={styles.input}>
          <Typography variant="h4">Asia Bukhara</Typography>
          <FormGroup>
            <Controller
              name="bukharaHotel__asiaBukhara__standard"
              control={control}
              defaultValue={false}
            ...
            {formData.bukharaHotel__asiaBukhara__standard && (
              <Grid xs={12} item>
                <div style={styles.input}>
                  ...
                  <Controller
                    name="bukharaHotel__asiaBukhara__standard__room"
                    control={control}
                    defaultValue={false}
                    render={({ field }) => (
                        ...
                        <RadioGroup {...field}>
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.SINGLE} - $${
                              BUKHARA_HOTEL_RATES.asiaBukhara.standard.single +
                              priceIncrease
                            }`}
                          />
                          <FormControlLabel
                            ...
                            label={`${ROOM_SIZES.DOUBLE} - $${
                              BUKHARA_HOTEL_RATES.asiaBukhara.standard.double +
                              priceIncrease
                            }`}
                          />
                        </RadioGroup>
